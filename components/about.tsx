...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"user","title":"출생","period":"1995. 1. 15.","description":"경상남도 진주시"},{"icon":"graduation","title":"중학교 입학","period":"2007. 3.","description":"삼현여자중학교"},{"icon":"graduation","title":"고등학교 입학","period":"2010. 3.","description":"경남정보고등학교"},{"icon":"graduation","title":"전문대학 입학","period":"2014. 3.","description":"대덕대학교 "},{"icon":"briefcase","title":"진주시청","period":"2017. 7. ","description":"공공근로 청년사업"},{"icon":"briefcase","title":"진주미르치과병원","period":"2018. 2.","description":"사원"},{"icon":"briefcase","title":"변호사 노경환 법률사무소","period":"2019. 8.","description":"주임"},{"icon":"briefcase","title":"궁전노인복지센터","period":"2022. 9.","description":"사회복지사"},{"icon":"briefcase","title":"법무법인 와이케이","period":"2023. 8.","description":"주임"}],
    skills: [],
    storyTitle: "나의 이야기",
    story: [],
    storyImage: "",
    hobbies: ["✈️ 여행","🎬 영화 감상","🎪 공연 관람"]
  }
