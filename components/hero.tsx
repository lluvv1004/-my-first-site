...
export function Hero() {
  ...
  // 초기 데이터 - 배열 형태로 변경
  const defaultSocialLinks = [{"name":"Instagram","icon":"instagram","url":"https://instagram.com/_luvv_1004_"}]
  
  const defaultInfo = {
    greeting: "반갑습니다.",
    name: "에롱공주",
    title: "PORTFOLIO",
    description: "해오름달 보름(01_15)",
    profileImage: "/uploads/hero-profile-1756966466325.jpg",
    background: {"image":"","video":"","color":"#ffdbdb","opacity":0.2},
    projectButton: "START"
  }
