...
export function Header() {
  ...
  const defaultConfig = {
    ...
    items: [{"name":"HOME","url":"#hero","icon":"Home","show":true},{"name":"INTRO","url":"#about","icon":"User","show":true},{"name":"PROJECT","url":"#projects","icon":"Briefcase","show":true},{"name":"CONTACT","url":"#contact","icon":"Mail","show":true},{"name":"갤러리","url":"#gallery","icon":"Camera","show":false},{"name":"블로그","url":"#blog","icon":"Book","show":false}],
    siteTitle: "에롱공주의 포트폴리오"
  }
